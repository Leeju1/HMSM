...
# Settings
input_dir <- "outputs/lamp_return/graphs/posterior_mean"
output_dir <- "outputs/lamp_return/ame"
...
comparisons <- data.frame(
  id = c("lamp_GB", "lamp_SK_GB"),
  A = c("prob1_GB", "prob1_SK"), B = c("prob0_GB", "prob1_GB"),
  label_A = c("Correct GB", "Correct SK"), label_B = c("Incorrect GB", "Correct GB"))
key_action <- c("wb_pg_8_4_reason_4", "wb_pg_8_4_submit", "wb_pg_8_4_request_1",
  "wb_pg_8_4", "wb", "wb_pg_8", "em", "em_m_view_305", "wb_hist_back", "keypress",
  "em_f_view", "wb_pg_8_2", "wb_pg_8_3")
paper_edges <- list(
  lamp_GB = rbind(c("wb_pg_8_4_reason_6", "wb_pg_8_4_reason_4"),
    c("wb_pg_8_4_reason_6", "wb_pg_8_4_request_1"), c("em_m_view_305", "wb"),
    c("em_m_view_305", "keypress")),
  lamp_SK_GB = rbind(c("wb_pg_8_4_reason_6", "wb_pg_8_4_reason_4")))
